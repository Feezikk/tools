...
const elements = {
    ...
    mapTopBar:         document.getElementById('map-top-bar'),
    dashboardGrid:       document.getElementById('dashboard-grid'),
    mapDetailArea:     document.getElementById('map-detail-area'),
    mapDetailContent:  document.getElementById('module-detail-content'),
    mapFilterRadios:   document.querySelectorAll('input[name="map-filter"]'),
...
const CONFIG_KEY  = 'courseSearch_mapConfig';
