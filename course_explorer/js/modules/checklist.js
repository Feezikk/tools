// =============================================================================
// CHECKLIST.JS
// Map configuration ('checklist') screen: choosing which modules/lessons to include in the curriculum map and syncing checkbox state.
// =============================================================================
...
function showConfigScreen() {
    ...
    try {
        ...
        console.warn(`Course Explorer: saved map config ("${CONFIG_KEY}" in localStorage) could not be parsed — falling back to defaults (all lessons checked).`, e);
    }
...
window.applyMapConfig = function applyMapConfig() {
    ...
    hasRunMapConfig = true;
    switchView('map');
};

window.reconfigureMap = function reconfigureMap() {
    hasRunMapConfig = false;
    switchView('map');
};
