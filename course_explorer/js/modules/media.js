        ...
        if (isUnlinked) {
            ...
            wrapper.innerHTML = `
                <table class="image-list-table downloads-table downloads-table-unlinked">
                    <colgroup>
                        <col class="col-filename"><col class="col-type"><col class="col-folder"><col class="col-status"><col class="col-structure"><col class="col-footer">
                    </colgroup>
            ...
            wrapper.innerHTML = `
                <table class="image-list-table downloads-table downloads-table-linked">
                    <colgroup>
                        <col class="col-location"><col class="col-title"><col class="col-type"><col class="col-structure"><col class="col-footer">
                    </colgroup>
                    <thead><tr><th>Location</th><th>Title/Filename</th><th>Type ${titleTypeCheckInfoButton()}</th><th>Structure Check ${structureCheckInfoButton()}</th><th>FLVS Footer ${footerCheckInfoButton()}</th></tr></thead>
                    <tbody>${tableRows}</tbody>
                </table>`;
        }
