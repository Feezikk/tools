        ...
        if (isUnlinked) {
            filtered.forEach(doc => {
                ...
                tableRows += `
                    <tr data-index="${idx}">
                        ...
                        <td><span class="flex-center gap-10" style="justify-content:flex-start;">${SVGS.fileText} <span class="downloads-filename-only">${escapeHtml(doc.fileName)}</span></span></td>
            ...
            wrapper.innerHTML = `
                <table class="image-list-table downloads-table downloads-table-unlinked">
                    <colgroup>
                        <col class="col-download"><col class="col-filename"><col class="col-type"><col class="col-folder"><col class="col-status"><col class="col-structure"><col class="col-footer">
                    </colgroup>
                    <thead><tr><th></th><th>Filename</th><th>Type</th><th>Folder</th><th>Status</th><th>Structure Check ${structureCheckInfoButton()}</th><th>FLVS Footer ${footerCheckInfoButton()}</th></tr></thead>
            ...
            wrapper.innerHTML = `
                <table class="image-list-table downloads-table downloads-table-linked">
                    <colgroup>
                        <col class="col-download"><col class="col-location"><col class="col-title"><col class="col-type"><col class="col-structure"><col class="col-footer">
                    </colgroup>
                    <thead><tr><th></th><th>Location</th><th>Title/Filename</th><th>Type ${titleTypeCheckInfoButton()}</th><th>Structure Check ${structureCheckInfoButton()}</th><th>FLVS Footer ${footerCheckInfoButton()}</th></tr></thead>
                    <tbody>${tableRows}</tbody>
                </table>`;
        }
